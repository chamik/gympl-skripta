...
#columns(2, gutter: 1em)[
  *Téma*\
  Myšlenkové probuzení člověka, který aktivně slouží režimu, který vymývá mozky a drží obyvatele pod kontrolou.
  
  *Motivy*\
  dystopický stát, válka, kontrola obyvatelstva/informací, intelektuální procitnutí

  *Časoprostor*\
  místo není uvedeno (nejspíš USA), někdy v budoucnosti
  
  *Postavy* \
  _Guy Montag_ -- hlavní hrdina, požárník \
  _Clarissa_ -- mladá dívka, která Montaga donutí se zamýšlet nad světem \
  _Mildred_ -- manželka Montaga, podlehla vymývání mozků \
  _Faber_ -- bývalý profesor, vystrašený režimem, pomáhá Montagovi \
  _Beatty_ -- velitel požárníků, podezírá Montaga, nakonec v konfliktu
  ...
  *Současníci*\
  ...
  _Karel Čapek_ -- R. U. R. (#underline[ODKAZ]), 1920 \
  // _Isaac Asimov_ -- Já, robot, 1950 \
  // _S. Beckett_ -- Čekání na Godota, 1952
]
