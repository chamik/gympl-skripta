...
#columns(2, gutter: 1em)[
  ...
  *Motivy*\
  obětování jedince pro potřeby společnosti, poukazování na bídu a důsledky války, práce, boje, činy

  *Časoprostor*\
  doba i místo autora
  
  *Postavy* \
  v každé básni jiné, typicky pro proletářskou poezii jsou to chudí lidé na okraji společnosti

  *Kompozice* 
  sbírka 22 převážně sociálních básní, 3 jsou balady.
...
a věřte dnes za mě, ţe tomu tak bude,\
a věřte dnes za mě, ţe postavím\
dle obrazu jeho\
