...
#columns(2, gutter: 1em)[
  *Téma*\
  touha pro zastavení války, varování před nacismem
  
  *Motivy*\
  individualita, touha po moci/slávě 

  *Časoprostor*\
  autorova současnost, místo neurčité (symbolika a původ však naznačuje Německo a Česko)
  
  *Postavy* \
  _Doktor Galén_ - naivní, snaží se zastavit válku (ref. na R. U. R #underline[@rur[]]) \
  ...
  *Kompozice*\
  chronologická, tragický konec

  // *Vypravěč*

  *Jazykové prostředky*\
  spisovná čeština, dialogy, cizí slova, nářečí, knižní slovní zásoba
  ...
  *Autor*\
  Český novinář, dramatik a spisovatel. Mladší bratr Josefa Čapka. Člen skupiny Pátečníci. Dobrý přítel T. G. M. Manžel herečky Olgy Scheinpflugové. Zemřel pár měsíců před okupací roku 1938.#footnote[Nejspíš pro jeho dobro; po abdikaci Edvarda Beneše se stal defakto symbolem první republiky a tak trochu obětním beránkem.] Jeho práce poukazuje na přílišnou rychlost lidského pokroku, kritizuje fašismus, podporuje pacifismus.
  ...
  *Současníci*\
  ...
  bratři Čapkovi - Zářivé hlubiny, 1916
]
