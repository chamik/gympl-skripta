...
#columns(2, gutter: 1em)[
  ...
  *Postavy* \
  ...
  _Král_, _Domýšlivec_, _Pijan_, _Byznysmen_, _Lampář_, _Zeměpisec_, _Výhybkář_, _Obchodník_ postavy které MP. potkal na své cestě

  *Kompozice* \
  27 krátkých kapitol, chronologicky, 

  *Vypravěč* -- ich-forma, v pasážích o životě Malého prince vševědoucí er-f.

  *Jazykové prostředky*\
  zdrobněliny, archaismy, přímá řeč, alegorie, vnitřní monolog (M. prince), symboly, metafory
