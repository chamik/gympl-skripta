...
#columns(2, gutter: 1em)[
  ...
  *Postavy* \
  _Roger Brown_ -- lovec hlav, egomaniak menšího vzrůstu, pompézní život \
  _Diana Brown_ -- jeho manželka, provozuje galerii, touží po dítěti \
  _Class Greve_ -- původně elitní voják najatý, aby se stal ředitelem konkurenční firmy vyrábějící GPS trackery \
  _Ove Kyinerud_ -- pomáhá Rogerovi s vloupáními, bezpečnostní agentura \
  ...
  *Obsah*\
  _Roger Brown_ je lovec hlav -- na vedoucí místa ve firmách dosazuje co možná nejlepší lidi. Zároveň je to zloděj umění. Své oběti si vyhlíží z řad lidí, které doporučuje. Jeho nejnovější kandidát je _Class Greve_, kterého chce doporučit na pozici šéfa GPS společnsti (ten je bývalým šéfem jiné technologické firmy, takže je dokonalý kandidát). _C_ je vlastníkem obrazu Lov kance (Paul Rubens), který má velkou hodnotu, _R_ neodolá. Za pomocí svého přítele _Ova_ se _R_ vloupá do domu _Classe_ a obraz ukradne. Celý štastný volá své manželce _Dianě_, jen aby zjistil, že mobil vyzvání pod _Classovou_ postelí. Vytuší nevěru a kvůli tomu se _Classe_ rozhodne nedoporučit. Řekne o tom své manželce, která informuje _Classe_. Ten se _Rogera_ pokusí uspat pomocí sedativ, ale místo toho uspí _Ova_. _R_ si myslí, že _Ove_ umřel a hodí ho do řeky, jen aby ho zase hned vytáhl; je přesvědčený, že _Ove_ je otráven, ovšem odmítá mu zavolat záchranku, v potyčce u něj doma ho zastřelí. _Lotta_ mu dá do vlasů GPS trackery (je bývalá milenka _Classe_), takže když se pokusí ukrýt na venkově, _C_ ho vystopuje. Musí se schovat do kadibudky (kde zjistí, že _C_ nemá varlata), zabije jeho psa a pokusí se ujet kombajnem. V nemocnici ho v převleku doktora _C_ skoro dostane, ovšem _Rogera_ dřív zatkne policie. V autě je _C_ srazí nákladákem, všichni kromě _R_ zemřou. _R_ si ostříhá vlasy, zabije _Lottu_, s _Dianou_ se domluví, at _Classovi_ vymění 3 náboje za slepé. Vydávaje se za policistu si dojde do márnice pro vlasy a naláká _C_ k _Oveovi_ domů. Následuje přestřelka, kterou _R_ vyhraje (a díky mrtvému _O_ na místě se zbaví viny). _R_ má s Dianou dítě.

  *Literárně historický kontext*\
  Popularita severských románů v posledních letech, současná společnost. Poe (#underline[@havran[]]) zakladatel detektivek.
]
