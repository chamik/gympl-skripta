...
#block(
  ...
  [#columns(3, gutter: 5pt)[
      ...
      *#smallcaps("povolání")*\
      spisovatel, novinář, dramatik, filozof, fotograf, překladatel

      #colbreak()

      *#smallcaps("vystudoval")*\
      gymnázium, estetiku na UK (doktorát z filozofie)

      *#smallcaps("směr")*\
      pragmatismus, protinacistická literatura
      
      #colbreak()    
      #align(center, image("/cj-autori/media/capek.jpg", height: 3.5cm))
  ]]
)
